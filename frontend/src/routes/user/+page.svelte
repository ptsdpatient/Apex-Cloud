    ...
    <div class="flex flex-col" style="width:100vw;height:100svh">
        ...
        <div class="flex flex-grow gap-2 justify-around p-2 flex-row bg-gray-100">
            <div class="w-1/4 px-3 py-5 flex flex-col items-left align-left gap-2  h-full rounded-lg overflow-y-auto">
                    <button class="text-lg rounded-lg py-2 my-1  transition-all bg-gray-500 hover:bg-blue-500 text-white hover:shadow-xl transform hover:scale-105 ease-in-out duration-100">Upload File</button>
            ...
            <div class="w-3/4 flex flex-col bg-white rounded-lg">
                <div class="flex flex-row w-full text-xl justify-between py-3 px-2 gap-3 shadow-sm">
                    <div class="flex flex-row gap-4">
                        <button class="px-4 text-xl rounded-lg py-1 mr-5 hover:bg-gray-100 text-black transition-all ease-in-out duration-100">←</button>
                        
                    </div>
                    <div>
                        <button class="px-4 mr-4 text-xl rounded-lg py-1  transition-all bg-gray-500 hover:bg-red-500 text-white hover:shadow-xl transform hover:scale-105 ease-in-out duration-100">Delete</button>
